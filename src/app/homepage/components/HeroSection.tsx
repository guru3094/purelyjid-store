    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#FAF6F0]">
      ...
      <div ref={heroImgRef} className="absolute inset-0 z-0 scale-110 will-change-transform">
        <AppImage
          ...
          alt="Colorful handcrafted resin art pieces"
          fill
          priority
      ...
      <div className="absolute bottom-1/3 right-16 w-48 h-48 rounded-full bg-secondary/10 blur-3xl" />
      ...
      <div className="relative z-10 text-center px-6 space-y-10 pt-24">
        ...
        >
          ...
          <span className="hero-word block italic text-muted-foreground opacity-60" style={{ opacity: 0 }}>
            JID.
          </span>
        </h1>
          ...
          <div className="flex gap-4">
            ...
            <Link
              ...
              onClick={(e) => {
                ...
                const message = "Hi PurelyJid, I'm interested in your products. Please share your catalog and pricing.";
            ...
            <Link
              href="/homepage#story"
              className="h-14 w-14 rounded-full border border-primary/30 flex items-center justify-center hover:bg-primary hover:text-white transition-all duration-500 text-foreground text-lg"
            >
              ↓
            </Link>
